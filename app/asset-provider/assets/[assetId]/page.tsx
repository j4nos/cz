  ...
  if (!asset) {
    return (
      <section>
        ...
        <p>The selected asset does not exist in the data store.</p>
        <p>
  ...
  return (
    <div className="vertical-stack-with-gap">
      ...
      {asset.imageUrls.length > 0 ? (
        <Carousel images={asset.imageUrls} altPrefix={asset.name ?? "Asset"} />
      ) : (
      ...
      <Button type="button" variant="ghost" onClick={() => void handleDeleteAsset()} disabled={deletingAsset}>
